...
class SqliteShopRepository(AbstractShopRepository):
    ...
    def create_shop(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        shop_id = self._conn_mgr.run_in_transaction(_op)
        return self.get_shop_by_id(shop_id)  # type: ignore
    ...
    def create_shop_item(self, shop_id: int, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        item_id = self._conn_mgr.run_in_transaction(_op)
        return self.get_shop_item_by_id(item_id)  # type: ignore
