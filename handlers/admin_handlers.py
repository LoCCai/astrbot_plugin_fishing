...
async def start_admin(plugin: "FishingPlugin", event: AstrMessageEvent):
    ...
    try:
        services_to_inject = {
            ...
            "aquarium_service": plugin.aquarium_service,
            "inventory_service": plugin.inventory_service,
            "loan_service": plugin.loan_service,
            "sicbo_service": plugin.sicbo_service,
            "blackjack_service": plugin.blackjack_service,
            "slot_service": plugin.slot_service,
